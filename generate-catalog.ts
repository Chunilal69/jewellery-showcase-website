...
necklaceEarringFiles.forEach((file, index) => {
  ...
  generatedItems.push({
    ...
    description,
    image: `/catalog/necklaces-earrings/${file}`,
    metal,
    purity,
    weight,
    isFeatured,
...
mangalsutraFiles.forEach((file, index) => {
  ...
  generatedItems.push({
    ...
    description,
    image: `/catalog/mangalsutra/${file}`,
    metal,
    purity,
    weight,
    isFeatured,
